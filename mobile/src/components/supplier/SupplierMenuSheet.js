...
const MENU_SECTIONS = [
  {
    title: "Operations",
    items: [
      { id: "dashboard", label: "Supplier dashboard", desc: "Home & quick actions", icon: "grid-outline", route: "/supplier-dashboard" },
      { id: "incoming", label: "Incoming orders", desc: "Accept & assign delivery", icon: "cart-outline", route: "/supplier-incoming-orders" },
      { id: "history", label: "Order history", desc: "Past & active orders", icon: "time-outline", route: "/supplier-order-history" },
    ],
  },
  {
    title: "Catalog & money",
  ...
  },
  {
    title: "Account",
    items: [
      { id: "support", label: "Support", desc: "Chat with admin", icon: "chatbubble-ellipses-outline", route: "/supplier-support" },
    ],
  },
];
...
export default function SupplierMenuSheet({ visible, onClose }) {
        ...
        <View style={styles.panel}>
          <LinearGradient colors={theme.gradient} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} style={styles.hero}>
            ...
            <View style={styles.heroBadge}>
              ...
              <Text style={styles.heroBadgeText}>Supplier portal</Text>
            </View>
          </LinearGradient>
